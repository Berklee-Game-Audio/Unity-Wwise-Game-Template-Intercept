...
//  Intro
	- 	They are keeping me waiting.
		*	Hut 14[]. The door was locked after I sat down. 
		...
		I am not a machine, whatever they say about me.  # wwiseEvent mx_waiting_stinger
...
= waited 
	...
	-	a small gesture of friendship. 
		Enough to give me hope?  # wwiseEvent mx_mystery_stinger
...
- 	"Quite a difficult situation," {lift_up_cup:he|Harris} begins{forceful <= 0:, sternly}. I've seen him adopt this stiff tone of voice before, but only when talking to the brass. "I'm sure you agree."
	...
	- 	{ teacup:
		...
		<>.  # wwiseEvent mx_calculating_stinger
...
=== missing_reel === 
	...
	*	[Shrug]
	...
	-	Any of us could have taken it; and no one else would have known its worth.
 		...
 		*	{forceful <= 0 }[Panic] They will pin it on me. They need a scapegoat so that the work can continue. I'm a likely target. Weaker than the rest. # wwiseEvent mx_mystery_stinger
 			~ lower(forceful)
 		*	[Calculate] My odds, then, are one in four. Not bad; although the stakes themselves are higher than I would like. # wwiseEvent mx_calculating_stinger
 			~ raise(evasive)
 		*	{evasive >= 0} [Deny] But this is still a mere formality. The work will not stop. A replacement component will be made and we will all be put back to work. We are too valuable to shoot. # wwiseEvent mx_mystery_stinger
 			~ raise(forceful)
 	-	->->


=== here_at_bletchley_diversion
	"Here at Bletchley? Of course." # wwiseEvent mx_calculating_stinger
 	~ raise(evasive)
 	~ lower(forceful)
 		...
 		* * 	"Of my genius.["] Hooper simply can't stand that I'm cleverer than he is. We work so closely together, cooped up in that Hut all day. It drives him to distraction. To worse."
				"You're suggesting Hooper would sabotage this country's future simply to spite you?" Harris chooses his words like the military man he is, each lining up to create a ring around me.
 					...
 					* * * 	[No] 			
								...
								~ teacup = false
 					* * * 	[Evade] 		
	 							"I don't know what I'm suggesting. I don't understand what's going on." # wwiseEvent mx_calculating_stinger
	 							~ raise(evasive)
...
=== harris_demands_component ===
	...
	- 	{ not missing_reel:
 		...
 		* 	[Co-operate] "I know where it is."
 			-> admitted_to_something
 		* (nothing) [Delay] "I know nothing about it." My voice shakes{ forceful > 0:  with anger|; I'm unaccustomed to facing off against men with holstered guns}. # wwiseEvent mx_tension_stinger
	...
	- 	"Lapsang Souchong," he {drinkfromcup:remarks|replies}, placing his own cup back on the table untouched. "Such a curious flavour. It might almost not be tea at all. You might say it hides a multitude of sins. As do you. Isn't that right?"
		 ...
		 * (suppose_i_have) [Agree] 
			 	// Regrets
				"I suppose so," I reply. "I've done things I shouldn't have done." # wwiseEvent mx_confession_stinger
				 ~ lower(forceful)
				 -> harris_presses_for_details

		* (nothing_ashamed_of) { not drugged  }   [Disagree]
		 		"I've done nothing that I'm ashamed of." # wwiseEvent mx_tension_stinger
		 ...
		 * { not drugged  }   [Evade] 
		 		"None of us are blameless, Harris. { forceful > 1:But you're not my priest and I'm not yours|But I've done nothing to deserve this treatment}. Now, please. Let me go. I'll help you find this damn component, of course I will." # wwiseEvent mx_waiting_stinger
				//   Who do you blame?
...
// Open to Blackmail
	"You mean you've left yourself open," Harris answers. "To pressure. Is that what you're saying?"
	 	...
	 	* { not drugged  } [No] 
	 			"I'm not saying anything of the sort," I snap back. "What is this, Harris? You're accusing me of treachery but I don't see a shred of evidence for it! Why don't you put your cards on the table?" # wwiseEvent mx_tension_stinger
			 	~ raise(forceful)
	 	...
	 	* { not drugged  } [Evade] 
	 			"You're the one applying pressure here," I answer { forceful > 1:smartly|somewhat miserably}. "I'm just waiting until you tell me what is really going on." # wwiseEvent mx_calculating_stinger
				 ~ raise(evasive)
	 	* { drugged  } [Evade] 				 
...
= admit_open_to_pressure
	...
	He offers no sympathy either. He nods, once. His understanding of me is a mere turning cog in his calculations, with no meaning to it. # wwiseEvent mx_confession_stinger
...
=== admitted_to_something
	...
	"I see." # wwiseEvent mx_confession_stinger
...
= i_know_where
	"I know where your component is because it's obvious where your component is. That doesn't mean I took it, just because I can figure out a simple problem, any more than it means I'm a German spy because I can crack their codes." # wwiseEvent mx_calculating_stinger
	-> harris_asks_for_theory
...
= an_accident
	...
	"Now," he continues. "Are you sure there isn't anything you want to tell me?" # wwiseEvent mx_tension_stinger
	 ...
	 * [Co-operate]
		 ...
		 ~ admitblackmail  = true
		Harris nods once. # wwiseEvent mx_confession_stinger
		<> -> harris_has_seen_it_before
	 ...
	 * {evasive > 0} [Evade] "Only that you're being unreasonable, and behaving like a swine."
		...
		"You imbecile," Harris replies, with sudden force. He is half out of his chair. "You know the situation as well as I do. Why the fencing? The Hun are poised like rats, ready to run all over this country. They'll destroy everything. You understand that, don't you? You're not so locked up inside your crossword puzzles that you don't see that, are you? This machine we have here — you men — you are the best and only hope this country has. God help her."
			~ losttemper  = true
			I sit back, startled by the force of his outburst. His carefully sculpted expression has curled to angry disgust. <i>He really does hate me</i>, I think. <i>He'll have my blood for the taste of it.</i> # wwiseEvent mx_tension_stinger
		* * [Placate]
...
=== harris_has_seen_it_before
	...
	"Now they own you." # wwiseEvent mx_confession_stinger
 ...
 * [Confess] 
		...
		"I can imagine how it starts," he replies. # wwiseEvent mx_confession_stinger
...
=== i_met_a_young_man
	...
	*	[Talk]
	...
	-	Harris is not letting me off any more. 
		"You seriously entertained that possibility?" # wwiseEvent mx_confession_stinger
	 * [Yes]
	 	"Yes, I considered it. <>
	 * [No] 
...
-  "Go on with your confession." # wwiseEvent mx_confession_stinger
- (paused) 
	 { not nope:
...
= passed_onto_hooper
	...
	"I see. And what did he do with it?" # wwiseEvent mx_mystery_stinger
	 * [Evade] 
	 	"I don't know."
...
//  Blame Hooper
	...
	- 	I have become, somehow, an accustomed liar — the words roll easily off my tongue. Perhaps I am a traitor, I think, now that I dissemble as easily as one.
		"Go on," Harris says, giving me no indication of whether he believes my tale. # wwiseEvent mx_calculating_stinger
	...
	- (we_wont_guess) <> We're not in the business of guessing here at Bletchley. We are military intelligence. We get answers." Harris points a finger. "And if that component has left these grounds, then every minute is critical." # wwiseEvent mx_tension_stinger
	 * [Co-operate] 
...
// Won't Help
	...
	"You'd better get on with solving it, instead of wasting your time in here with me." # wwiseEvent mx_mystery_stinger
 	-> harrumphs
...
= go_in_alone
	...
	* 	[Impatient] "For God's sake, man, what do you have to lose?" 
	...
	- 	"We'll be outside the door," Harris replies, seriously. "The first sign of any funny business and we'll have you both on the floor in minutes. You understand? The country needs your brain, but it's not too worried about your legs. Remember that."
		...
		"You ready?" Harris demands. # wwiseEvent mx_tension_stinger
 	* (yes) [Yes]
 			"Absolutely."
 	* 	[No]
 			"No."
...
=== harris_takes_you_to_hooper
	// Past Hooper
	Harris gets to his feet. "All right," he says. "I should know better than to trust a clever man, but we'll give it a go." 
	 ...
	 * 	(shouted) [Call to Hooper] 
		...
		"I'll get you Hooper, you'll see!" I cry. Then:
		 	...
		 	* * "Queen to rook two, checkmate!"[] I call, then laugh viciously, as if I am damning him straight to hell. # wwiseEvent mx_calculating_stinger
			...
			He stares back at me, as if were a madman and perhaps for a split second I see him shudder. # wwiseEvent mx_calculating_stinger
			 

		 	* * "Two words: messy, without one missing!"[] I cry, laughing. It isn't the best clue, hardly worthy of The Times, but it will have to do. # wwiseEvent mx_calculating_stinger
...
=== inside_hoopers_hut
	 ...
	 *	 [Threaten]
	 		"Listen to me, Hooper. We were the only men in that hut today, so we know what happened. But I want you to know this. I put the component inside a breeze—block in the foundations of Hut 2, wrapped in one of your shirts. They're going to find it eventually, and that's going to be what tips the balance. And there's nothing you can do to stop any of that from happening." # wwiseEvent mx_tension_stinger
	 ...
	 * [Plead] 
		...
		"Help you?" Hooper stares. "Help you? You're a traitor. A snake in the grass. And you're <i>queer</i>." # wwiseEvent mx_mystery_stinger
		 * * 	[Deny] 
...
=== slam_door_shut_and_gone
	Then they slam the door shut, and it locks. # wwiseEvent mx_waiting_stinger
	{ hooperClueType == NONE :
...
=== smash_the_window
	//  Smashing glass
		Then I heft { smashingWindowItem == BUCKET :up the bucket — this really is quite a fiddly thing to be doing in cuffs — |{ smashingWindowItem == SHOE : my shoe by its toe, |back my arm, }} and take a strong swing, trying to imagine it's Harris' face on the other side. # wwiseEvent mx_tension_stinger
	 	~ smashedglass  = true
...
=== go_to_hoopers_dorm
	...
	I hang back for a moment. If Harris is keeping to the terms of our deal then someone will be watching this place. But I can see no—one. # wwiseEvent mx_tension_stinger
...
// In room smashed glass
	...
	"What happened there?" # wwiseEvent mx_mystery_stinger
 	* [Confess] 
...
= someone_threw_component
	...
	He turns the component over in his hands, bemused. # wwiseEvent mx_mystery_stinger
	 ~ piecereturned  = true
	 * [Suggest something] 
...
= found_missing_component
	// Framed Hooper
	We found the missing component. Or rather, Hooper found it for us. He snuck out and retrieved it from on top. Of all the damnest places — you would never have known it was there. He claimed ignorance when we jumped him, of course. But it's good enough for me." # wwiseEvent mx_calculating_stinger
	 * (devil) [Approve]
...
=== night_falls ===
//  Night falls
	Night falls. The clockwork of the heavens keeps turning, whatever state I might be in. No—one can steal the components that make the sun go down and the stars come out. I watch it performing its operations. I can't sleep. # wwiseEvent mx_waiting_stinger
	{ hooperClueType > NONE  :
 	...
 	* 	{ hooperClueType > NONE  }   	[Wait] 
		...
		* * 	[Be cautious] 
		...
		- - 	"The Captain went back into that hut and he confessed immediately. We were so surprised we didn't let you go." He wrinkles his nose. "I'm rather sorry about that now. I suggest you have a wash."
				And with that he gestures to the doorway. # wwiseEvent mx_waiting_stinger
 			* * 	[Go] 
 			* * 	[Wait] 
		...
		- - 	Curiouser and curiouser. I nod once to Harris and slip outside into the cold morning air.
			...
			* * [Don't check]
					But there will time for that later. If there is nothing there, then Hooper discovered the component after all and Harris' men will have swooped on him, and the story about his confession is just a ruse to test me out. # wwiseEvent mx_calculating_stinger
...
=== ending_return_to_normal
Nothing, that is, except to act as if there is no game being played. I'll have a bath, then start work as normal. I've got a week to find something to give my blackmailer{ i_met_a_young_man : — or give him nothing: it seems my superiors know about my indiscretions now already}. # wwiseEvent mx_calculating_stinger
 * [Co-operate] 
...
=== left_alone
	//  Alone, about to die
	{ slam_door_shut_and_gone.time_to_move_now :The Commander holds the door for his superior, and follows him out.} Then the door closes. I am alone again, as I have been for most of my short life. # wwiseEvent mx_confession_stinger
	 -> make_your_peace
...
=== make_your_peace
	* [Make your peace]
	...
	- 	<> I suppose I do not believe they will hang me. They will lock me up and continue to use my brain, if they can. I wonder what they will tell the world — perhaps that I have taken my own life. That would be simplest. The few who know me would believe it. # wwiseEvent mx_confession_stinger
	...
	- 	{ not longgrasshooperframe  :
		...
		He looks me in the eye. # wwiseEvent mx_confession_stinger
		{ not losttemper  :
